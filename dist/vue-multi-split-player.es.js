var Ct = (a, e) => (e = Symbol[a]) ? e : Symbol.for("Symbol." + a);
var f = (a, e, i) => new Promise((t, l) => {
  ...
  }, d = (u) => u.done ? t(u.value) : Promise.resolve(u.value).then(n, s);
  ...
  }, l = (s) => n[s] = (d) => new Promise((u, c) => t(s, d, u, c)), n = {};
  return i = i.apply(a, e), n[Ct("asyncIterator")] = () => n, l("next"), l("throw"), l("return"), n;
};
import { ref as g, inject as ft, computed as vt, onMounted as It, onBeforeUnmount as wt, watch as he, nextTick as Bt } from "vue";
...
function fe(a, e, i, t, l, n, s, d) {
  var u = typeof a == "function" ? a.options : a;
  return e && (u.render = e, u.staticRenderFns = i, u._compiled = !0), n && (u._scopeId = "data-v-" + n), {
    exports: a,
    options: u
  };
}
const Gt = {
  ...
  methods: {
    ...
    updateCurrentTime(a) {
      a < 0 && (a = 0), a >= this.duration && (a = this.duration), window.requestIdleCallback ? window.requestIdleCallback((e) => this.$emit("update", a)) : ct((e) => this.$emit("update", a), 100);
    },
    /**
...
class Jt {
  ...
  create_animate1(e) {
    let i = 2, t = this.width - e.offsetWidth - 40, l = this.height - e.offsetHeight - 40, n = (Math.random() * t).toFixed(0), s = (Math.random() * l).toFixed(0), d = {
      transform: `translate(calc(${n}px),calc(${s}px))`
    };
    e.animate(d, {
      duration: 0,
      fill: "forwards",
  ...
  observe_p(e) {
    ...
    this.observer_p = new MutationObserver((t, l) => {
      for (let n of t)
        switch (n.type) {
          case "childList":
            let s = Array.from(n.removedNodes);
...
let _ = () => function(a, e, i) {
  let t = i.value;
  i.value = function(...l) {
    return t.apply(this, l);
  };
}, Yt = (Ve = _(), Ze = _(), Ue = _(), We = _(), B = class {
  constructor(e) {
  ...
  createVideo(e, i) {
    try {
      ...
      if (l.poster = te, l.controls = !1, l.autoplay = !1, l.muted = !1, l.preload = "auto", l.volume = 0, l.classList = ["video__"], ut(i)) {
        let n = new Hls();
...
}, X(B.prototype, "_init", [Ve], Object.getOwnPropertyDescriptor(B.prototype, "_init"), B.prototype), X(B.prototype, "createVideo", [Ze], Object.getOwnPropertyDescriptor(B.prototype, "createVideo"), B.prototype), X(B.prototype, "addVttSubtitle", [Ue], Object.getOwnPropertyDescriptor(B.prototype, "addVttSubtitle"), B.prototype), X(B.prototype, "initEvent", [We], Object.getOwnPropertyDescriptor(B.prototype, "initEvent"), B.prototype), B);
function Vt(a) {
  let e = g(null), i = g(null), t = 0.2, l = (c, m) => {
    var I, C, y, w;
    c.value = c, i.value = m, c.value && ((I = c.value) == null || I.addEventListener("click", n), (C = c.value) == null || C.addEventListener("dblclick", n), (y = c.value) == null || y.addEventListener("mousedown", J(d, t * 1e3)), (w = c.value) == null || w.addEventListener("mouseup", J(u, t * 1e3)));
  }, n = (c) => {
    c.stopPropagation();
  }, s = () => {
    var c, m, I, C;
    (c = e.value) == null || c.removeEventListener("click", n), (m = e.value) == null || m.removeEventListener("dblclick", n), (I = e.value) == null || I.removeEventListener("mousedown", J(d, t * 1e3)), (C = e.value) == null || C.removeEventListener("mouseup", J(u, t * 1e3));
  }, d = (c) => {
    c.stopPropagation();
    let m = c.target;
...
let ee = () => function(a, e, i) {
...
}, Zt = (Xe = ee(), _e = ee(), $e = ee(), et = ee(), Q = class {
  constructor(e) {
  ...
  _init() {
    return W(this, null, function* () {
      ...
      if (!l)
        throw new Error("player url is required");
      if (yield yield new L(this.createVideo(e, l, d)), yield yield new L(this.createControlLayout(e, i, d)), !this.player)
        return {
          value: void 0,
          done: !0
        };
  ...
  createVideo(n, s, d) {
    return f(this, arguments, function* (e, i, t, l = 0) {
      ...
      try {
        ...
        m.id = `video_${e}`, m.classList = ["video__"], m.controls = !1, m.autoplay = !0, m.playsInline = !0, m.preload = "auto", m.poster = te, m.volume = 0, m.controls = !1, c.appendChild(m), this.player = yield Streamedian.player(m.id, {
          socket: i,
          // redirectNativeMediaErrors: true,
          bufferDuration: 10,
          dataHandler: this._handleData,
          errorHandler: (I) => this._handlerError(I, ...u, l)
        });
      } catch (c) {
        throw new Error(c);
      }
...
}, $(Q.prototype, "_init", [Xe], Object.getOwnPropertyDescriptor(Q.prototype, "_init"), Q.prototype), $(Q.prototype, "createVideo", [_e], Object.getOwnPropertyDescriptor(Q.prototype, "createVideo"), Q.prototype), $(Q.prototype, "createControlLayout", [$e], Object.getOwnPropertyDescriptor(Q.prototype, "createControlLayout"), Q.prototype), $(Q.prototype, "initEvent", [et], Object.getOwnPropertyDescriptor(Q.prototype, "initEvent"), Q.prototype), Q);
var tt, it, at, R;
...
let ge = () => function(a, e, i) {
  ...
  _init() {
    return W(this, null, function* () {
      ...
      if (!l)
        throw new Error("player url is required");
      if (yield yield new L(this.createVideo(e, l, d)), !this.player)
        return {
          value: void 0,
          done: !0
        };
  ...
  createVideo(n, s, d) {
    return f(this, arguments, function* (e, i, t, l = 0) {
      ...
      try {
        ...
        c.id = `video_${e}`, c.classList = ["video__"], c.controls = !1, c.autoplay = !1, c.playsInline = !0, c.preload = "auto", c.poster = te, c.volume = 0, u.appendChild(c), this.player = new ZLMRTCClient.Endpoint({
          element: c,
          // video 标签
          debug: !1,
          // 是否打印日志
...
}, me(S.prototype, "_init", [nt], Object.getOwnPropertyDescriptor(S.prototype, "_init"), S.prototype), me(S.prototype, "createVideo", [lt], Object.getOwnPropertyDescriptor(S.prototype, "createVideo"), S.prototype), me(S.prototype, "initEvent", [rt], Object.getOwnPropertyDescriptor(S.prototype, "initEvent"), S.prototype), S);
function Xt(a, e) {
  var l;
  let i = a;
  i != null || (i = "");
  ...
  if (i !== "" && e.length) {
    let n = String((l = e.find((s) => s.id === i)) == null ? void 0 : l.value);
    n && (t.value = dt(n));
  }
  return {
    voiceChannel: t
...
function ei(a) {
  let e = a.eventBus, i = a.video_player, t = document.querySelector(`#${a.playId}`), l = null, n = null, s = () => {
    let p = i.length;
    Array.from({
      length: p
    }, (O, H) => {
    ...
    if (l) {
      clearTimeout(l), l = null, e.emit("maximize", p);
      return;
    }
    l = setTimeout(() => {
      l = null, e.emit("switch", p);
    }, 200);
  }, C = (p) => {
    let O = p.target;
    O.classList.contains("maximize") || (O.classList.add("dragstart"), n = p.target);
  }, y = (p) => {
    n && n !== p.target && p.target.classList.add("dragging");
  }, w = (p) => {
    n && n !== p.target && p.target.classList.remove("dragging");
  }, k = (p) => {
    n && (p.target.classList.remove("dragstart"), n = null);
  }, x = (p) => {
    n && (p.target.classList.remove("dragging"), e.emit("dragend", {
      target: n,
      source: p.target
    }));
  }, b = (p) => {
...
const ti = "data:audio/mp4;base64,", At = "data:image/png;base64,", st = "data:image/png;base64,", ii = "data:image/png;base64,", ai = {
  ...
  setup(a, { expose: e, emit: i }) {
    const t = a;
    let l = ft("pubsub", void 0), { isExists: n } = $t(), s = null, { voiceChannel: d } = Xt(t.classroomType, t.voiceConfig), u = g(!0), c = g(!1), m = g([]), I = g([]), C = g([]), y = g([]), w = g(""), k = g(0), x = g(0), b = g(!1), p = g(/* @__PURE__ */ new Set([])), O = g(["高清", "标清"]), H = g("高清"), ie = g(["0.5", "1.0", "1.5", "2.0", "5.0"]), v = g(/* @__PURE__ */ new Set([])), Y = g("1.0"), j = g(0), pt = g(!1), ve = g(localStorage.getItem("loop") === "true"), Ie = g(!1), V = g(""), q = g(""), Z = g(!1), we = g({}), Be = g(null), U = g(null), G = g(!1), P = g(!1), F = g(!1), ae = g(!1), gt = vt(() => t.width ? {
      width: `${t.width}px`,
      height: `${t.height}px`
    } : {});
    It(() => {
    ...
    let Qe = () => f(this, null, function* () {
      if (u.value = !0, m.value.length) {
        ...
        v.value.size || (v.value = new Set(A.map((o) => o.id))), C.value = A.filter((o) => v.value.has(o.id)), yield be(), yield new Promise((o) => setTimeout(o, 10)), Bt((o) => f(this, null, function* () {
          C.value.map((h, E) => {
            let D = {};
            t.mode === "vod" ? D = new Yt({
              url: h.url,
      ...
      if (yield ke(r), yield M("muted"), k.value && t.mode === "vod" && (yield M("current", k.value)), t.autoplay || ae.value ? yield M("play") : yield M("pause"), t.mode === "vod" && (yield le()), t.autoplay)
        try {
          yield Je(), console.log("Allow play with voice");
        } catch (A) {
          console.log("Not allow play with voice"), yield M("volume", 0);
        }
      !t.muted && (yield Re()), t.isEnableToolbar && (yield ne()), ae.value = !0, i("ready");
    }), Me = () => {
      ...
      y.value.map((o, h) => {
        switch (r) {
          ...
          case "muted":
            ...
            break;
          case "rate":
            o.setPlaybackRate(+A), Y.value !== A && (Y.value = A);
            break;
          case "current":
            o.seek(A), k.value = A;
            break;
      ...
      r.onPlayTime = (A) => {
        A && (k.value = A), l && l.publish("currentPlayTime", k.value), t.mode === "vod" && i("timeupdate", A);
      }, r.onPlayState = (A) => {
        b.value = A, l && l.publish("syncVideo", +b.value);
      }, r.onPlayFinish = (A) => {
        b.value = !1, ve.value && M("replay");
      ...
      t.isEnableWaterMarker && (q.value = `player_wrap_${(/* @__PURE__ */ new Date()).getTime()}`, V.value = new Jt({ id: q.value, content: t.waterMarkerContent }));
    }, Se = () => {
      ...
      }), x.value || (yield new Promise((r) => setTimeout(r, 500)), le());
    }), xe = (r) => {
      ...
      Be.value.handleChange(document.getElementById("video_player")), setTimeout((r) => {
        t.mode === "vod" && U.value._getDistance();
      }, 40);
    }, Ge = (r) => {
      ...
      s == null || s.destroy(), z.destroy(), M("destroy"), q.value && (V.value.destroy(), q.value = ""), c.value = !1, y.value = [], p.value = /* @__PURE__ */ new Set([]);
    }, ue = () => {
      ce(), C.value = [], v.value = /* @__PURE__ */ new Set([]), Ie.value = !1, Y.value = "1.0", k.value = 0, x.value = 0, j.value = 70, b.value = !1;
    }, yt = (r) => {
      ...
      Ee((r) => {
        parent.document.webkitIsFullScreen || parent.document.fullscreen || parent.document.mozFullScreen || parent.document.msFullscreenElement, t.mode === "vod" && U.value._getDistance(), q.value && (V.value.destroy(), ne());
      }, 200);
...
var ni = function() {
  ...
  return i("div", { staticClass: "video_player_pc _flex_center", style: t.videoPlayerStyle, attrs: { id: "video_player" } }, [i("div", { staticClass: "player_wrap", class: { player_wrap_pip: t.isPipMode && t.resource_list.length === 2 }, style: t.resource_list.length === 1 ? { width: "auto", height: "100%" } : {}, attrs: { id: `${t.waterMarkerId}` } }, [t.resource_list.length === 1 ? i("div", { staticClass: "player_list default_screen", attrs: { id: `${t.playId}` } }, [i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_1" } })]) : e._e(), t.resource_list.length === 2 ? i("div", { staticClass: "player_list two_split_screen _flex_item_center", attrs: { id: `${t.playId}` } }, [i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip, pip_main: t.isPipMode }, staticStyle: { width: "50%" }, attrs: { id: "player_item_1" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip, pip_sub: t.isPipMode }, staticStyle: { width: "50%" }, attrs: { id: "player_item_2" } })]) : e._e(), t.resource_list.length === 3 ? i("div", { staticClass: "player_list _flex_item_center three_split_screen", attrs: { id: `${t.playId}` } }, [i("div", { staticStyle: { width: "50%", height: "100%" } }, [i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, staticStyle: { height: "50%" }, attrs: { id: "player_item_1" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, staticStyle: { height: "50%" }, attrs: { id: "player_item_2" } })]), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, staticStyle: { width: "100%" }, attrs: { id: "player_item_3" } })]) : e._e(), t.resource_list.length === 4 ? i("div", { staticClass: "player_list _flex_item_center four_split_screen", attrs: { id: `${t.playId}` } }, [i("div", { staticStyle: { width: "26.6%" } }, [i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_1" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_2" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_3" } })]), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_4" } })]) : e._e(), t.resource_list.length === 5 ? i("div", { staticClass: "player_list _flex_item_center five_split_screen", attrs: { id: `${t.playId}` } }, [i("div", { staticStyle: { width: "25%" } }, [i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_1" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_2" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_3" } }), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, attrs: { id: "player_item_4" } })]), i("div", { staticClass: "player_item _flex_item_center", class: { flip: t.flip }, staticStyle: { width: "100%" }, attrs: { id: "player_item_5" } })]) : e._e(), t.is_init ? e._e() : i("div", { staticClass: "player_loading _flex_center" }, [i("img", { attrs: { src: te, alt: "" } })])]), e.isEnableToolbar ? i("footer", { style: t.is_loading ? { pointerEvents: "none" } : {} }, [e.mode === "vod" ? i(t.Slide, { ref: "slide", attrs: { duration: +t.duration, mark: e.noteList }, on: { update: (l) => t._register_emits("current", l) }, model: { value: t.current, callback: function(l) {
    ...
    return i("div", { key: n, staticClass: "item _flex_center", attrs: { disabled: e.muted }, on: { click: function(s) {
    ...
    return i("div", { key: n, staticClass: "item _flex_center", class: { active: t.rate === l }, on: { click: function(s) {
    ...
    return i("div", { key: n, staticClass: "item _flex_center", class: { active: t.channel_list.has(l.id) }, on: { click: function(s) {
    ...
    return i("div", { key: n, staticClass: "item _flex_center", class: { active: t.voice.has(l.sceneName) }, attrs: { disabled: e.muted }, on: { click: function(s) {
      return t.handle_click("muted", l);
    } } }, [t.voice.has(l.sceneName) ? i("img", { attrs: { src: At, alt: "" } }) : i("img", { attrs: { src: st, alt: "" } }), i("span", [e._v(e._s(l.sceneName))])]);
  ...
  } } }, [t.volume === 0 ? i("img", { attrs: { src: st, alt: "" } }) : t.volume >= 50 ? i("img", { attrs: { src: At, alt: "" } }) : t.volume > 0 ? i("img", { attrs: { src: ii, alt: "" } }) : e._e()]), i("div", { staticClass: "voice_slide" }, [i("el-slider", { staticStyle: { width: "100%" }, attrs: { min: 0, max: 100 }, on: { change: function(l) {
